...
bool isIdealPermutation( int *nums, int numsSize ) {
    //global e local=param, basicamente, qnd a var de glb tiver +mov pra estar na posc
    //Retorne true se o numero de inversoes globais for igual ao numero de inversoes locais
    //Entrada: nums = [1,2,0] Saida: false (ha 2 inversoes globais e 1 inversao local)

    int t,j,g=0,l=0;
    int *m1=malloc(sizeof(numsSize));
    *m1=*nums;
    int *m2=malloc(sizeof(numsSize));
